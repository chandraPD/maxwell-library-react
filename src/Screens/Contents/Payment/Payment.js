                ...
                <section class="content-header">
                    ...
                    <div class="row mb-2">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="fine_management.html">Fine Management</a></li>
              ...
              <div className="row">
                <div className="col-sm-6">
                  <div className="form-group">
                    ...
                    <select className="form-control inv-selector" id="selector">
                ...
                <div className="invoice p-3 mb-3">
                  ...
                  <div className="row no-print">
                    <div className="col-12">
                      ...
                      <button type="submit" data-toggle="modal" data-target="#modal-decline" className="btn btn-danger float-right custom-dcl"><i className="far fa-credit-card"></i> Pay (Declined)
                      </button>
                ...
                <div className="invoice p-3 mb-3">
                  ...
                  <div className="row">
                    <div className="col-12">
                      <h4>
                        <img src={MaxIcon} style={{height: "2rem"}}/> Maxwell Library
                        <small className="float-right">Date: 18/11/2020</small>
                      </h4>
                    </div>
                    {/* <!-- /.col --> */}
                  </div>
                  ...
                  <div className="row">
                    ...
                    {/* <!-- /.col --> */}
                    <div className="col-6">
                      <p className="lead float-right">Amount Due 19/11/2020</p>
                  ...
                  <div className="row no-print">
                    <div className="col-12">
                      ...
                      <button type="submit" data-toggle="modal" data-target="#modal-confirm" className="btn btn-success float-right "><i className="far fa-credit-card"></i> Pay
                      </button>
                      <button type="submit" data-toggle="modal" data-target="#modal-decline" className="btn btn-danger float-right custom-dcl"><i className="far fa-credit-card"></i> Pay (Declined)
                      </button>
                    </div>
                ...
                <div className="invoice p-3 mb-3">
                  ...
                  <div className="row">
                    <div className="col-12">
                      <h4>
                        <img src={MaxIcon} style={{height: "2rem"}}/> Maxwell Library
                        <small className="float-right">Date: 20/11/2020</small>
                      </h4>
                    </div>
                    {/* <!-- /.col --> */}
                  </div>
                  ...
                  <div className="row">
                    ...
                    {/* <!-- /.col --> */}
                    <div className="col-6">
                      <p className="lead float-right">Amount Due 24/11/2020</p>
